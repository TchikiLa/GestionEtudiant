package com.etudiant.mvc.dao.impl;
...
import com.etudiant.mvc.dao.I_ElearningDAO;
...
public class ElearningDAO_impl<E> implements I_ElearningDAO<E> {
	...
	public List<E> selectALL() {
		Query query = em.createNamedQuery("select t from " + type.getSimpleName() + " t");
		return query.getResultList();
	}
	
	@Override
	public List<E> selectALL(String sortfield,String sort) {
		Query query = em.createNamedQuery("select t from " + type.getSimpleName() + " t order by " + sortfield + " " + sort);
		return query.getResultList();
	}
	...
	public E findOne(String paramName, Object paramValue) {
		...
		Query query = em.createNamedQuery("select t from " + type.getSimpleName() + " t where " + paramName + " = :x");
